...
namespace unittests
{
    public class LocalFunctionTests
    {
        ...
        [Test]
        public void BasicAddFourIntTest_ShouldReturnExpectedWatCode()
        {
            var module = new Module();
            ...
            var add = module.Binary(BinaryOperator.AddInt32, w,x, y, z);

            var adder = module.AddFunction("adder", signature, add);
            var wat = module.ToWat();
            Assert.AreEqual(Regex.Unescape("(module (type $add (func (param i32 i32 i32 i32) (result i32))) (func $adder (; 0 ;) (type $add) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32) (i32.add (get_local $0) (get_local $1) (get_local $2) (get_local $3))))"), wat);
        }

        [Test]
        public void BasicAddFiveIntTest_ShouldReturnExpectedWatCode()
        {
            var module = new Module();
            ...
            var adder = module.AddFunction("adder", signature, add);
            var wat = module.ToWat();
            Assert.AreEqual(Regex.Unescape("(module (type $add (func (param i32 i32 i32 i32 i32) (result i32))) (func $adder (; 0 ;) (type $add) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (result i32) (i32.add (get_local $0) (get_local $1) (get_local $2) (get_local $3) (get_local $4))))"), wat);
        }
