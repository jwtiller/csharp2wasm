...
{
    [TestFixture]
    public class SubtractTwoIntegersTests
    {
        ...
        public void Setup()
        {
            ...
            var add = module.Binary(BinaryOperator.SubInt32, x, y);
        ...
        {
            Assert.AreEqual(Regex.Unescape($"(module (type $add (func (param i32 i32) (result i32))) (export \"mathFunc\" (func $module/mathFunc)) (func $module/mathFunc (type $add) (param $0 i32) (param $1 i32) (result i32) (i32.sub (get_local $0) (get_local $1))))"), wasmTextCode);
        }
        ...
        public void ShouldReturn_Two()
        {
            ...
            using (var module = Module.FromText(engine, "add", wasmTextCode))
            {
                ...
                var result = run?.Invoke(store, 4, 2);
