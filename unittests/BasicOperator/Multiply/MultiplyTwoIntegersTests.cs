...
{
    [TestFixture]
    public class MultiplyTwoIntegersTests
    {
        ...
        {
            Assert.AreEqual(Regex.Unescape($"(module (type $add (func (param i32 i32) (result i32))) (export \"mathFunc\" (func $module/mathFunc)) (func $module/mathFunc (type $add) (param $0 i32) (param $1 i32) (result i32) (i32.mul (get_local $0) (get_local $1))))"), wasmTextCode);
        }
        ...
        public void ShouldReturn_ThirtySix()
        {
            ...
            using (var module = Module.FromText(engine, "add", wasmTextCode))
            {
                ...
                var result = run?.Invoke(store, 6, 6);
