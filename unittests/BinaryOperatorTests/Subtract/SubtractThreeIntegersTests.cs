...
{
    [TestFixture]
    public class SubtractThreeIntegersTests : TestBase<int>
    {
        ...
        public void Setup()
        {
            ...
            var add = module.Binary(csharp2wasm.BinaryOperator.SubInt32, x, y, z);
        ...
        {
            var result = ExecuteWasmCode("add", "mathFunc", 10, 2, 2);
