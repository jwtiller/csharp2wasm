...
{
    [TestFixture]
    public class MultiplyFourIntegersTests : BinaryOperatorTest
    {
        ...
        public void Setup()
        {
            ...
            var add = module.Binary(csharp2wasm.BinaryOperator.MulInt32, w, x, y, z);
        ...
        {
            var result = ExecuteWasmCode("add", "mathFunc", 2,2,2,2);
