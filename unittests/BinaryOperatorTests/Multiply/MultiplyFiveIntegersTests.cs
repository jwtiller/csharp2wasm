...
{
    [TestFixture]
    public class MultiplyFiveIntegersTests : BinaryOperatorTest
    {
        ...
        public void Setup()
        {
            ...
            var add = module.Binary(csharp2wasm.BinaryOperator.MulInt32, v,w, x, y, z);
        ...
        public void AssertExpectedWebassemblyText()
        {
            Assert.AreEqual(
                Regex.Unescape(
                    $"(module (type $add (func (param i32 i32 i32 i32 i32) (result i32))) (export \"mathFunc\" (func $module/mathFunc)) (func $module/mathFunc (type $add) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (result i32) (i32.mul (get_local $0) (get_local $1) i32.mul (get_local $2) i32.mul (get_local $3) i32.mul (get_local $4))))"),
                WebassemblyText);
        }

        [Test]
        public void ShouldReturn_ThirtyTwo()
        {
            var result = ExecuteWasmCode("add", "mathFunc", 2,2,2,2,2);
