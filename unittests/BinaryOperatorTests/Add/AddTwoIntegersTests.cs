...
{
    [TestFixture]
    public class AddTwoIntegersTests : BinaryOperatorTest
    {
        [SetUp]
        public void Setup()
        {
            ...
            var add = module.Binary(csharp2wasm.BinaryOperator.AddInt32, x, y);
        ...
        {
            Assert.AreEqual(Regex.Unescape($"(module (type $add (func (param i32 i32) (result i32))) (export \"mathFunc\" (func $module/mathFunc)) (func $module/mathFunc (type $add) (param $0 i32) (param $1 i32) (result i32) (i32.add (get_local $0) (get_local $1))))"), WebassemblyText);
        }

        [Test]
        public void ShouldReturn_Six()
        {
            var result = ExecuteWasmCode("add", "mathFunc",3, 3);
